...
- Tech Lead команды из 5 backend-разработчиков на проекте корпоративной геймификации
- Запустил в продакшн 2 собственных коммерческих продукта: VPN-сервис [@Trinity_main_bot](https://t.me/Trinity_main_bot) и платформу [Slife](https://s-life.ru)
